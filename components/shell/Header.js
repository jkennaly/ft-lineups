...
import { events } from '../../services/active'
...
export default function Header({ active }) {
  ...
  const navigation = [
    { name: 'My Festivals', href: '/game/splash', current: /game\/splash/.test(router.pathname) },
    festivalRoute && { name: 'Festival', href: festivalRoute, current: /game\/series/.test(router.pathname) },
    yearRoute && { name: 'Year', href: yearRoute, current: /game\/year/.test(router.pathname) },
    dateRoute && { name: 'Date', href: dateRoute, current: /game\/date/.test(router.pathname) },
    dayRoute && { name: 'Day', href: dayRoute, current: /game\/day/.test(router.pathname) },
    setRoute && { name: 'Set', href: setRoute, current: /game\/set/.test(router.pathname) }
  ].filter(x => x)
  return (
